...
public class NMSArgumentMobEffect_v1_19_3 extends NMSArgumentMobEffect {
    public NMSArgumentMobEffect_v1_19_3() {
    ...
    protected NMSMobEffectList parseImpl(CommandContext<?> ctx, String name) {
        return NMSMobEffectList.create(NMSHolder.NMSReference.create(invokeStaticMethod("f", ctx, name))
                                                             .value());
    }
}
