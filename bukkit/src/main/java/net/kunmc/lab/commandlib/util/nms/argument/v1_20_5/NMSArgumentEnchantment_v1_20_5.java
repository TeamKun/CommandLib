...
public class NMSArgumentEnchantment_v1_20_5 extends NMSArgumentEnchantment {
    public NMSArgumentEnchantment_v1_20_5() {
    ...
    protected NMSEnchantment parseImpl(CommandContext<?> ctx, String name) {
        return NMSEnchantment.create(NMSHolder.NMSReference.create(invokeStaticMethod("getEnchantment", ctx, name))
                                                           .value());
    }
}
