...
public final class RequiredTriArgumentBranch<S, T1, T2, T3, C extends CommonCommandContext<?, ?>, T extends CommonCommand<C, T>> extends RequiredArgumentBranch<S, C, T> {
